...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        if (res.status === 409) {
          setError(`This email already has GENID: ${data.genidCode}. Go to your dashboard.`)
        } else {
    ...
    <div className="max-w-lg mx-auto px-6 py-20">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-400">
          Verify your identity once. Stamp your AI content forever.
        </p>
      </div>
      ...
      {step === 'form' && (
        <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-800 rounded-xl p-8 space-y-5">
          ...
          >
            {loading ? 'Starting Verification...' : 'Verify Identity with Stripe →'}
          </button>
